...
public class CLIHandler 
{
	...
	{
		theOption_S = Option.builder(DEF_SERVER_OPT).longOpt(DEF_SERVER_LONGOPT).desc(DEF_SERVER_OPT_DESC).build();
		theCommandLineOptions.addOption(theOption_S);
		theOption_P = Option.builder(DEF_PORT_OPT).longOpt(DEF_PORT_LONGOPT).desc(DEF_PORT_OPT_DESC).build();
		theCommandLineOptions.addOption(theOption_P);
		theOption_l = Option.builder(DEF_LOGIN_OPT).longOpt(DEF_ALL_LONGOPT).desc(DEF_ALL_OPT_DESC).build();
		theCommandLineOptions.addOption(theOption_l);
		theOption_p = Option.builder(DEF_PASSWORD_OPT).longOpt(DEF_PASSWORD_LONGOPT).desc(DEF_PASSWORD_OPT_DESC).build();
		theCommandLineOptions.addOption(theOption_p);
		theOption_d = Option.builder(DEF_DELETE_OPT).longOpt(DEF_DELETE_LONGOPT).desc(DEF_DELETE_OPT_DESC).build();
		theCommandLineOptions.addOption(theOption_d);
		theOption_a = Option.builder(DEF_ALL_OPT).longOpt(DEF_ALL_LONGOPT).desc(DEF_ALL_OPT_DESC).build();
		theCommandLineOptions.addOption(theOption_a);
		theOption_f = Option.builder(DEF_FOLDERS_OPT).longOpt(DEF_FOLDERS_LONGOPT).desc(DEF_FOLDERS_OPT_DESC).build();;
		theCommandLineOptions.addOption(theOption_f);
		theOption_h = Option.builder(DEF_HELP_OPT).longOpt(DEF_HELP_LONGOPT).desc(DEF_HELP_OPT_DESC).build();;
	 ...
	 * Default constructor.
	 * 
	 * @param args Arguments taken in from the command line at the beggining of execution.
	 */
